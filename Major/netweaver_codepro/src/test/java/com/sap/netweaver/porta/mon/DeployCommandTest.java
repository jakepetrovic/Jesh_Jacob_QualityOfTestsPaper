...
/**
 * The class <code>DeployCommandTest</code> contains tests for the class <code>{@link DeployCommand}</code>.
 *
...
public class DeployCommandTest {
	...
	public void testExecute_1()
		throws Exception {
		DeployCommand fixture = new DeployCommand();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(DeployCommandTest.class);
	}
}