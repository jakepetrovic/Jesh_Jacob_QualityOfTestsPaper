...
/**
 * The class <code>StartAppCommandTest</code> contains tests for the class <code>{@link StartAppCommand}</code>.
 *
 * @generatedBy CodePro at 4/8/14 10:43 AM
 * @author Jeshua
 * @version $Revision: 1.0 $
 */
public class StartAppCommandTest {
	/**
	...
	public void testExecute_1()
		throws Exception {
		StartAppCommand fixture = new StartAppCommand();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(StartAppCommandTest.class);
	}
}