...
/**
 * The class <code>RestartCommandTest</code> contains tests for the class <code>{@link RestartCommand}</code>.
 *
...
public class RestartCommandTest {
	...
	public void testExecute_1()
		throws Exception {
		RestartCommand fixture = new RestartCommand();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(RestartCommandTest.class);
	}
}