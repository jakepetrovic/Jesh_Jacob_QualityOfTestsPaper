...
public class MyOutputStreamTest {
	...
	public void testMyOutputStream_1()
		...
		//    java.lang.UnsupportedClassVersionError: nu/staldal/lagoon/producer/MyOutputStream : Unsupported major.minor version 51.0
	...
	public void testClose_1()
		throws Exception {
		MyOutputStream fixture = new MyOutputStream(new MyInputStream());
