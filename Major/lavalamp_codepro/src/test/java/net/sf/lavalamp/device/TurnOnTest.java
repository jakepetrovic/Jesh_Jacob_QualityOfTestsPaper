...
/**
 * The class <code>TurnOnTest</code> contains tests for the class <code>{@link TurnOn}</code>.
 *
...
public class TurnOnTest {
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(TurnOnTest.class);
	}
}