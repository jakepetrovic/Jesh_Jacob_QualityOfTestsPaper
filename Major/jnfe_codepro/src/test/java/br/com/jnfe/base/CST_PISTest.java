...
/**
 * The class <code>CST_PISTest</code> contains tests for the class <code>{@link CST_PIS}</code>.
 *
 * @generatedBy CodePro at 4/19/14 3:00 PM
 * @author Jeshua
 * @version $Revision: 1.0 $
 */
public class CST_PISTest {
	/**
	...
	public void testGetDesc_1()
		throws Exception {
		CST_PIS fixture = CST_PIS.PIS_01;
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(CST_PISTest.class);
	}
}