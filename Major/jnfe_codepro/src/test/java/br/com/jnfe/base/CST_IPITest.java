...
/**
 * The class <code>CST_IPITest</code> contains tests for the class <code>{@link CST_IPI}</code>.
 *
 * @generatedBy CodePro at 4/19/14 3:00 PM
 * @author Jeshua
 * @version $Revision: 1.0 $
 */
public class CST_IPITest {
	/**
	...
	public void testGetDesc_1()
		throws Exception {
		CST_IPI fixture = CST_IPI.IPI_00;
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(CST_IPITest.class);
	}
}