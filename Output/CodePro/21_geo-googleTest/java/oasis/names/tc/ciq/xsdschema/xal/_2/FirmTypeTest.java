...
/**
 * The class <code>FirmTypeTest</code> contains tests for the class <code>{@link FirmType}</code>.
 *
 * @generatedBy CodePro at 6/7/15 3:07 PM
 * @author Jesh
 * @version $Revision: 1.0 $
 */
public class FirmTypeTest {
	/**
	 ...
	 * @generatedBy CodePro at 6/7/15 3:07 PM
	 */
	public FirmType getFixture1()
		throws Exception {
		if (fixture1 == null) {
			fixture1 = new FirmType();
		}
		return fixture1;
	}
	 ...
	 * @generatedBy CodePro at 6/7/15 3:07 PM
	 */
	public FirmType getFixture2()
		throws Exception {
		if (fixture2 == null) {
			fixture2 = new FirmType();
	 ...
	 * @generatedBy CodePro at 6/7/15 3:07 PM
	 */
	public FirmType getFixture3()
		throws Exception {
		if (fixture3 == null) {
			fixture3 = new FirmType();
	 ...
	 * @generatedBy CodePro at 6/7/15 3:07 PM
	 */
	public FirmType getFixture4()
		throws Exception {
		if (fixture4 == null) {
			fixture4 = new FirmType();
	...
	/**
	 * Run the List<Department> getDepartment() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 6/7/15 3:07 PM
	...
	public void testGetDepartment_fixture1_1()
		...
		List<Department> result = fixture.getDepartment();
	...
	/**
	 * Run the List<FirmType.FirmName> getFirmName() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 6/7/15 3:07 PM
	 */
	@Test
	public void testGetFirmName_fixture1_1()
		throws Exception {
		FirmType fixture = getFixture1();

		List<FirmType.FirmName> result = fixture.getFirmName();
	 ...
	 */
	@Test
	public void testGetFirmName_fixture2_1()
		throws Exception {
		FirmType fixture = getFixture2();
	 ...
	 */
	@Test
	public void testGetFirmName_fixture3_1()
		throws Exception {
		FirmType fixture = getFixture3();
	 ...
	 */
	@Test
	public void testGetFirmName_fixture4_1()
		throws Exception {
		FirmType fixture = getFixture4();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(FirmTypeTest.class);
	}
}