...
/**
 * The class <code>SnippetShutdownInstanceAuthCallbackTest</code> contains tests for the class <code>{@link SnippetShutdownInstanceAuthCallback}</code>.
 *
 * @generatedBy CodePro at 4/8/14 10:37 AM
 * @author Jeshua
 * @version $Revision: 1.0 $
 */
public class SnippetShutdownInstanceAuthCallbackTest {
	/**
	 * Run the SnippetShutdownInstanceAuthCallback() constructor test.
	 *
	 * @generatedBy CodePro at 4/8/14 10:37 AM
	 */
	@Test
	public void testSnippetShutdownInstanceAuthCallback_1()
		throws Exception {
		SnippetShutdownInstanceAuthCallback result = new SnippetShutdownInstanceAuthCallback();
	...
	public void testMain_1()
		...
		SnippetShutdownInstanceAuthCallback.main(args);
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(SnippetShutdownInstanceAuthCallbackTest.class);
	}
}