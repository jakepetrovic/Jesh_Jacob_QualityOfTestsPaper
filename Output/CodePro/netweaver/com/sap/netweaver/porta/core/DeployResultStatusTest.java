...
public class DeployResultStatusTest {
	 ...
	 */
	@Test
	public void testDeployResultStatus_1()
		throws Exception {
		String name = "";

		DeployResultStatus result = new DeployResultStatus(name);

		// add additional test code here
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.UnsupportedClassVersionError: com/sap/netweaver/porta/core/DeployResultStatus : Unsupported major.minor version 51.0
