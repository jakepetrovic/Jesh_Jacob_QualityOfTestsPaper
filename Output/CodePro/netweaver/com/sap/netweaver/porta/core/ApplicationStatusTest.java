...
public class ApplicationStatusTest {
	 ...
	 */
	@Test
	public void testApplicationStatus_1()
		throws Exception {
		String name = "";

		ApplicationStatus result = new ApplicationStatus(name);

		// add additional test code here
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.UnsupportedClassVersionError: com/sap/netweaver/porta/core/ApplicationStatus : Unsupported major.minor version 51.0
