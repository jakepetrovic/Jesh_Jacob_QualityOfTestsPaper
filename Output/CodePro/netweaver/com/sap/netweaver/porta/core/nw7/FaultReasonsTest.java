...
public class FaultReasonsTest {
	 ...
	 */
	@Test
	public void testFaultReasons_1()
		throws Exception {
		String faultReason = "";

		FaultReasons result = new FaultReasons(faultReason);

		// add additional test code here
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.UnsupportedClassVersionError: com/sap/netweaver/porta/core/nw7/FaultReasons : Unsupported major.minor version 51.0
