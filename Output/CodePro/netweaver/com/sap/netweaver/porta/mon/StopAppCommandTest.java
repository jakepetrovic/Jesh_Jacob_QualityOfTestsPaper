...
/**
 * The class <code>StopAppCommandTest</code> contains tests for the class <code>{@link StopAppCommand}</code>.
 *
 * @generatedBy CodePro at 4/8/14 11:41 AM
 * @author Jeshua
 * @version $Revision: 1.0 $
 */
public class StopAppCommandTest {
	/**
	...
	public void testExecute_1()
		throws Exception {
		StopAppCommand fixture = new StopAppCommand();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(StopAppCommandTest.class);
	}
}