...
/**
 * The class <code>StartCommandTest</code> contains tests for the class <code>{@link StartCommand}</code>.
 *
...
public class StartCommandTest {
	...
	public void testExecute_1()
		throws Exception {
		StartCommand fixture = new StartCommand();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(StartCommandTest.class);
	}
}