...
/**
 * The class <code>CountdownMsgTest</code> contains tests for the class <code>{@link CountdownMsg}</code>.
 *
...
public class CountdownMsgTest {
	 ...
	 * @generatedBy CodePro at 6/14/15 5:15 PM
	 */
	public CountdownMsg getFixture()
		throws Exception {
		if (fixture == null) {
			fixture = new CountdownMsg(0);
		}
		return fixture;
	}

	/**
	 * Run the CountdownMsg(int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 6/14/15 5:15 PM
	 */
	@Test
	public void testCountdownMsg_1()
		throws Exception {
		int number = 0;

		CountdownMsg result = new CountdownMsg(number);
	 ...
	 */
	@Test
	public void testCountdownMsg_2()
		throws Exception {
		int number = 1;
	 ...
	 */
	@Test
	public void testCountdownMsg_3()
		throws Exception {
		int number = 7;
	...
	public void testExecute_fixture_1()
		throws Exception {
		CountdownMsg fixture2 = getFixture();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(CountdownMsgTest.class);
	}
}