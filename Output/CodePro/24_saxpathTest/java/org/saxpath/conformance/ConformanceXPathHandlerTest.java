...
/**
 * The class <code>ConformanceXPathHandlerTest</code> contains tests for the class <code>{@link ConformanceXPathHandler}</code>.
 *
 * @generatedBy CodePro at 7/4/15 1:00 PM
 * @author Jesh
 * @version $Revision: 1.0 $
 */
public class ConformanceXPathHandlerTest {
	/**
	 * An instance of the class being tested.
	 *
	 * @see ConformanceXPathHandler
	 *
	 * @generatedBy CodePro at 7/4/15 1:00 PM
	 */
	private ConformanceXPathHandler fixture;
	 ...
	 * @generatedBy CodePro at 7/4/15 1:00 PM
	 */
	public ConformanceXPathHandler getFixture()
		throws Exception {
		if (fixture == null) {
			fixture = new ConformanceXPathHandler();
		}
		return fixture;
	}

	/**
	 * Run the ConformanceXPathHandler() constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 7/4/15 1:00 PM
	 */
	@Test
	public void testConformanceXPathHandler_1()
		throws Exception {

		ConformanceXPathHandler result = new ConformanceXPathHandler();
	...
	public void testEndAbsoluteLocationPath_fixture_1()
		throws Exception {
		ConformanceXPathHandler fixture2 = getFixture();
	...
	public void testEquals_fixture_1()
		throws Exception {
		ConformanceXPathHandler fixture2 = getFixture();
		Object thatObj = new ConformanceXPathHandler();

		boolean result = fixture2.equals(thatObj);
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(ConformanceXPathHandlerTest.class);
	}
}