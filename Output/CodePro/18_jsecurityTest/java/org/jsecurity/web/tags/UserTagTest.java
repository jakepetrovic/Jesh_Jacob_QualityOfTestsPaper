...
/**
 * The class <code>UserTagTest</code> contains tests for the class <code>{@link UserTag}</code>.
 *
...
public class UserTagTest {
	/**
	 * Run the UserTag() constructor test.
	 *
	 * @generatedBy CodePro at 4/19/14 3:13 PM
	 */
	@Test
	public void testUserTag_1()
		throws Exception {
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(UserTagTest.class);
	}
}