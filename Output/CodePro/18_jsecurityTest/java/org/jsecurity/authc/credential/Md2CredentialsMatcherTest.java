...
/**
 * The class <code>Md2CredentialsMatcherTest</code> contains tests for the class <code>{@link Md2CredentialsMatcher}</code>.
 *
 * @generatedBy CodePro at 4/19/14 3:32 PM
 * @author Jeshua
 * @version $Revision: 1.0 $
 */
public class Md2CredentialsMatcherTest {
	/**
	...
	public void testHashProvidedCredentials_1()
		throws Exception {
		Md2CredentialsMatcher fixture = new Md2CredentialsMatcher();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(Md2CredentialsMatcherTest.class);
	}
}