...
/**
 * The class <code>NaturalPkIdentityTest</code> contains tests for the class <code>{@link NaturalPkIdentity}</code>.
 *
 * @generatedBy CodePro at 6/7/15 8:01 PM
 * @author Jesh
 * @version $Revision: 1.0 $
 */
public class NaturalPkIdentityTest {
	/**
	 * An instance of the class being tested.
	 *
	 * @see NaturalPkIdentity
	 *
	 * @generatedBy CodePro at 6/7/15 8:01 PM
	 */
	private NaturalPkIdentity fixture;
	 ...
	 * @generatedBy CodePro at 6/7/15 8:01 PM
	 */
	public NaturalPkIdentity getFixture()
		throws Exception {
		if (fixture == null) {
			fixture = new NaturalPkIdentity("");
		}
		return fixture;
	}

	/**
	 * Run the NaturalPkIdentity(String) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 6/7/15 8:01 PM
	 */
	@Test
	public void testNaturalPkIdentity_1()
		throws Exception {
		String tableName = "";

		NaturalPkIdentity result = new NaturalPkIdentity(tableName);

		// add additional test code here
		assertNotNull(result);
		assertEquals(" identity by primary key", result.getDescription());
		assertEquals("NaturalPkIdentity()", result.toString());
	 ...
	 */
	@Test
	public void testNaturalPkIdentity_2()
		throws Exception {
		...
		// add additional test code here
		assertNotNull(result);
		assertEquals("0123456789 identity by primary key", result.getDescription());
		assertEquals("NaturalPkIdentity(0123456789)", result.toString());
	...
	public void testCreateNkPkIterator_fixture_1()
		throws Exception {
		NaturalPkIdentity fixture2 = getFixture();
	...
	public void testGetDescription_fixture_1()
		...
		// add additional test code here
		assertEquals(" identity by primary key", result);
	}
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(NaturalPkIdentityTest.class);
	}
}