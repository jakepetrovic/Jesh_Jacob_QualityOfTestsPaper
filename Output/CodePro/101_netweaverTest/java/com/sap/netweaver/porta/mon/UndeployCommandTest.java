...
/**
 * The class <code>UndeployCommandTest</code> contains tests for the class <code>{@link UndeployCommand}</code>.
 *
...
public class UndeployCommandTest {
	...
	public void testExecute_1()
		throws Exception {
		UndeployCommand fixture = new UndeployCommand();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(UndeployCommandTest.class);
	}
}