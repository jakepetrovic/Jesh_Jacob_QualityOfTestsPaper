...
/**
 * The class <code>ListAppsCommandTest</code> contains tests for the class <code>{@link ListAppsCommand}</code>.
 *
 * @generatedBy CodePro at 4/8/14 10:37 AM
 * @author Jeshua
 * @version $Revision: 1.0 $
 */
public class ListAppsCommandTest {
	/**
	...
	public void testExecute_1()
		throws Exception {
		ListAppsCommand fixture = new ListAppsCommand();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(ListAppsCommandTest.class);
	}
}