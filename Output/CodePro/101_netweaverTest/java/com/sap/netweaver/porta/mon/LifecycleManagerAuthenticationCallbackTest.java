...
/**
 * The class <code>LifecycleManagerAuthenticationCallbackTest</code> contains tests for the class <code>{@link LifecycleManagerAuthenticationCallback}</code>.
 *
 * @generatedBy CodePro at 4/8/14 10:37 AM
 * @author Jeshua
 * @version $Revision: 1.0 $
 */
public class LifecycleManagerAuthenticationCallbackTest {
	/**
	...
	public void testGetCredentials_1()
		throws Exception {
		LifecycleManagerAuthenticationCallback fixture = new LifecycleManagerAuthenticationCallback();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(LifecycleManagerAuthenticationCallbackTest.class);
	}
}