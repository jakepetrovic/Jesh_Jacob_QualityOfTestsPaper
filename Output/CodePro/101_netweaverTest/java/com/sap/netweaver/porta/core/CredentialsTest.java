...
public class CredentialsTest {
	...
	public void testCredentials_1()
		...
		Credentials result = new Credentials(user, password);

		// add additional test code here
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.UnsupportedClassVersionError: com/sap/netweaver/porta/core/Credentials : Unsupported major.minor version 51.0
