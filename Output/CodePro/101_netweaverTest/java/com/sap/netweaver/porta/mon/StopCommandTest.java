...
/**
 * The class <code>StopCommandTest</code> contains tests for the class <code>{@link StopCommand}</code>.
 *
...
public class StopCommandTest {
	...
	public void testExecute_1()
		throws Exception {
		StopCommand fixture = new StopCommand();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(StopCommandTest.class);
	}
}