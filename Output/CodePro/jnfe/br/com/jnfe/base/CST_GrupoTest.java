...
/**
 * The class <code>CST_GrupoTest</code> contains tests for the class <code>{@link CST_Grupo}</code>.
 *
 * @generatedBy CodePro at 4/19/14 3:00 PM
 * @author Jeshua
 * @version $Revision: 1.0 $
 */
public class CST_GrupoTest {
	/**
	...
	public void testGetGroup_1()
		throws Exception {
		CST_Grupo fixture = CST_Grupo._00;
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(CST_GrupoTest.class);
	}
}