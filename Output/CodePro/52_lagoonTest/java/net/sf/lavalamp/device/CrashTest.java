...
/**
 * The class <code>CrashTest</code> contains tests for the class <code>{@link Crash}</code>.
 *
...
public class CrashTest {
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(CrashTest.class);
	}
}