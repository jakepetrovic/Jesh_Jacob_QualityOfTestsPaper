...
/**
 * The class <code>DirSourceTest</code> contains tests for the class <code>{@link DirSource}</code>.
 *
...
public class DirSourceTest {
	 ...
	 * @generatedBy CodePro at 6/28/15 2:35 PM
	 */
	public DirSource getFixture()
		throws Exception {
		if (fixture == null) {
			fixture = new DirSource();
		}
		return fixture;
	}
	...
	public void testStart_fixture_1()
		...
		//    java.lang.RuntimeException: No SourceManager avaliable
		//       at nu.staldal.lagoon.core.Producer.getSourceMan(Producer.java:171)
		//       at nu.staldal.lagoon.producer.DirSource.start(DirSource.java:71)
	}
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(DirSourceTest.class);
	}
}