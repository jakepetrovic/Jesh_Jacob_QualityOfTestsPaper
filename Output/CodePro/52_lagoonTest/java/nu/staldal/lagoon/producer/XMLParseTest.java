...
/**
 * The class <code>XMLParseTest</code> contains tests for the class <code>{@link XMLParse}</code>.
 *
...
public class XMLParseTest {
	 ...
	 * @generatedBy CodePro at 6/28/15 2:39 PM
	 */
	public XMLParse getFixture()
		throws Exception {
		if (fixture == null) {
			fixture = new XMLParse();
		}
		return fixture;
	}
	...
	public void testRun_fixture_1()
		...
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.NullPointerException
		//       at nu.staldal.lagoon.producer.XMLParse.run(XMLParse.java:162)
	}
	...
	public void testStart_fixture_1()
		...
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.NullPointerException
		//       at nu.staldal.lagoon.producer.XMLParse.start(XMLParse.java:88)
	}
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(XMLParseTest.class);
	}
}