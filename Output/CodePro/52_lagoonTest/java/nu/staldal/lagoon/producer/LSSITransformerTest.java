...
/**
 * The class <code>LSSITransformerTest</code> contains tests for the class <code>{@link LSSITransformer}</code>.
 *
 * @generatedBy CodePro at 6/28/15 2:38 PM
 * @author Jesh
 * @version $Revision: 1.0 $
 */
public class LSSITransformerTest {
	/**
	 ...
	 * @generatedBy CodePro at 6/28/15 2:38 PM
	 */
	private LSSITransformer fixture;
	 ...
	 * @generatedBy CodePro at 6/28/15 2:38 PM
	 */
	public LSSITransformer getFixture()
		throws Exception {
		if (fixture == null) {
			fixture = new LSSITransformer();
		}
		return fixture;
	}
	...
	public void testHasBeenUpdated_fixture_1()
		throws Exception {
		LSSITransformer fixture2 = getFixture();
		long when = -1L;
	...
	public void testStart_fixture_1()
		...
		//       at nu.staldal.lagoon.producer.LSSITransformer.start(LSSITransformer.java:66)
	}
	...
	public void testStart_fixture_2()
		...
		//    java.lang.RuntimeException: No SourceManager avaliable
		//       at nu.staldal.lagoon.core.Producer.getSourceMan(Producer.java:171)
		//       at nu.staldal.lagoon.producer.LSSITransformer.start(LSSITransformer.java:70)
	}
	...
	public void testStart_fixture_26()
		...
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.NullPointerException
		//       at org.iso_relax.verifier.impl.ForkContentHandler.startDocument(ForkContentHandler.java:55)
		//       at nu.staldal.lagoon.producer.LSSITransformer.start(LSSITransformer.java:66)
	}
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(LSSITransformerTest.class);
	}
}