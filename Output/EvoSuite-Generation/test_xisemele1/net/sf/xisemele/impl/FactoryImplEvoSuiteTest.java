...
public class FactoryImplEvoSuiteTest {
  ...
  public void test6()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        factoryImpl0.createWriter((Document) null, "~UKLm");
        fail("Expecting exception: NullPointerException");
      } catch(NullPointerException e) {
      }
  }
  ...
  /*
   * 1 covered goal:
   * 1 net.sf.xisemele.impl.FactoryImpl.createAttributes(Ljava/util/List;)Ljava/util/List;: I14 Branch 1 IFEQ L68 - true
   */
  @Test
