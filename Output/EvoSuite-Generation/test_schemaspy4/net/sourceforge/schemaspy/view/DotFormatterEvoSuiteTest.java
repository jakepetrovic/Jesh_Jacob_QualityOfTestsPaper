...
public class DotFormatterEvoSuiteTest {
  ...
  public void test1()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        dotFormatter0.writeAllRelationships((Table) null, false, (WriteStats) null, (LineWriter) null);
        fail("Expecting exception: NullPointerException");
      } catch(NullPointerException e) {
      }
  }
   ...
   * 3 net.sourceforge.schemaspy.view.DotFormatter.writeRelationships(Lnet/sourceforge/schemaspy/model/Database;Ljava/util/Collection;ZZZLnet/sourceforge/schemaspy/view/WriteStats;Lnet/sourceforge/schemaspy/util/LineWriter;)Z: I11 Branch 48 IFNE L273 - false
   ...
   * 5 net.sourceforge.schemaspy.view.DotFormatter.writeRelationships(Lnet/sourceforge/schemaspy/model/Database;Ljava/util/Collection;ZZZLnet/sourceforge/schemaspy/view/WriteStats;Lnet/sourceforge/schemaspy/util/LineWriter;)Z: I53 Branch 51 IFEQ L283 - true
   */
  @Test
  public void test3()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        dotFormatter0.writeRealRelationships((Database) null, (Collection<Table>) hashSet0, false, true, (WriteStats) null, (LineWriter) null);
        fail("Expecting exception: NullPointerException");
      } catch(NullPointerException e) {
      }
  }
  ...
  /*
   * 6 covered goals:
   * 1 net.sourceforge.schemaspy.view.DotFormatter.writeRelationships(Lnet/sourceforge/schemaspy/model/Database;Ljava/util/Collection;ZZZLnet/sourceforge/schemaspy/view/WriteStats;Lnet/sourceforge/schemaspy/util/LineWriter;)Z: I11 Branch 48 IFNE L273 - true
   * 2 net.sourceforge.schemaspy.view.DotFormatter.writeRelationships(Lnet/sourceforge/schemaspy/model/Database;Ljava/util/Collection;ZZZLnet/sourceforge/schemaspy/view/WriteStats;Lnet/sourceforge/schemaspy/util/LineWriter;)Z: I53 Branch 51 IFEQ L283 - false
   * 3 net.sourceforge.schemaspy.view.DotFormatter.getInstance()Lnet/sourceforge/schemaspy/view/DotFormatter;: root-Branch
   * 4 net.sourceforge.schemaspy.view.DotFormatter.writeRealRelationships(Lnet/sourceforge/schemaspy/model/Database;Ljava/util/Collection;ZZLnet/sourceforge/schemaspy/view/WriteStats;Lnet/sourceforge/schemaspy/util/LineWriter;)V: root-Branch
   * 5 net.sourceforge.schemaspy.view.DotFormatter.writeRelationships(Lnet/sourceforge/schemaspy/model/Database;Ljava/util/Collection;ZZZLnet/sourceforge/schemaspy/view/WriteStats;Lnet/sourceforge/schemaspy/util/LineWriter;)Z: I7 Branch 47 IFEQ L273 - false
  ...
  public void test5()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        dotFormatter0.writeRealRelationships((Database) null, (Collection<Table>) linkedList0, true, true, writeStats0, (LineWriter) null);
        fail("Expecting exception: NullPointerException");
      } catch(NullPointerException e) {
      }
  }
