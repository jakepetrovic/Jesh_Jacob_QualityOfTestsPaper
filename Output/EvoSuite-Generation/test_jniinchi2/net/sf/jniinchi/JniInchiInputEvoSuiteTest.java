...
public class JniInchiInputEvoSuiteTest {
   ...
   * 3 net.sf.jniinchi.JniInchiInput.<init>(Ljava/lang/String;)V: I8 Branch 1 IFNONNULL L48 - false
   */
  @Test
  ...
  public void test3()  throws Throwable  {
      ...
      try {
        jniInchiInput1 = new JniInchiInput((JniInchiStructure) jniInchiInput0, "jeej,@g7L*W9hU");
        fail("Expecting exception: NoClassDefFoundError");
      } catch(NoClassDefFoundError e) {
        /*
         * net/sf/jnati/NativeCodeException
