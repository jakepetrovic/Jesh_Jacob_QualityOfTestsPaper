...
public class WildcardPermissionEvoSuiteTest {
  ...
  /*
   * 16 covered goals:
   * 1 org.jsecurity.authz.permission.WildcardPermission.getParts()Ljava/util/List;: root-Branch
   ...
   * 6 org.jsecurity.authz.permission.WildcardPermission.<init>(Ljava/lang/String;Z)V: I61 Branch 4 IFNE L144 - true
   * 7 org.jsecurity.authz.permission.WildcardPermission.<init>(Ljava/lang/String;Z)V: I72 Branch 5 IFLE L148 - true
   * 8 org.jsecurity.authz.permission.WildcardPermission.<init>(Ljava/lang/String;Z)V: I95 Branch 6 IFLE L155 - true
   * 9 org.jsecurity.authz.permission.WildcardPermission.implies(Lorg/jsecurity/authz/Permission;)Z: I4 Branch 8 IFNE L181 - true
   * 10 org.jsecurity.authz.permission.WildcardPermission.implies(Lorg/jsecurity/authz/Permission;)Z: I31 Branch 9 IFEQ L190 - true
   * 11 org.jsecurity.authz.permission.WildcardPermission.implies(Lorg/jsecurity/authz/Permission;)Z: I31 Branch 9 IFEQ L190 - false
   * 12 org.jsecurity.authz.permission.WildcardPermission.implies(Lorg/jsecurity/authz/Permission;)Z: I44 Branch 10 IF_ICMPGE L194 - true
   * 13 org.jsecurity.authz.permission.WildcardPermission.implies(Lorg/jsecurity/authz/Permission;)Z: I62 Branch 11 IFGT L200 - true
   * 14 org.jsecurity.authz.permission.WildcardPermission.implies(Lorg/jsecurity/authz/Permission;)Z: I62 Branch 11 IFGT L200 - false
   * 15 org.jsecurity.authz.permission.WildcardPermission.implies(Lorg/jsecurity/authz/Permission;)Z: I66 Branch 12 IFGT L200 - true
   * 16 org.jsecurity.authz.permission.WildcardPermission.implies(Lorg/jsecurity/authz/Permission;)Z: I83 Branch 13 IF_ICMPGE L210 - true
   */
  @Test
  ...
  public void test5()  throws Throwable  {
      ...
      WildcardPermission wildcardPermission0 = new WildcardPermission("AbD\"(A66`k/&kB^4Eg7");
      assertNotNull(wildcardPermission0);
  ...
  public void test6()  throws Throwable  {
      ...
      WildcardPermission wildcardPermission1 = new WildcardPermission("*");
   ...
   * 10 org.jsecurity.authz.permission.WildcardPermission.<init>(Ljava/lang/String;Z)V: I61 Branch 4 IFNE L144 - true
   * 11 org.jsecurity.authz.permission.WildcardPermission.<init>(Ljava/lang/String;Z)V: I61 Branch 4 IFNE L144 - false
   * 12 org.jsecurity.authz.permission.WildcardPermission.<init>(Ljava/lang/String;Z)V: I72 Branch 5 IFLE L148 - true
   * 13 org.jsecurity.authz.permission.WildcardPermission.<init>(Ljava/lang/String;Z)V: I95 Branch 6 IFLE L155 - true
   * 14 org.jsecurity.authz.permission.WildcardPermission.implies(Lorg/jsecurity/authz/Permission;)Z: I4 Branch 8 IFNE L181 - true
