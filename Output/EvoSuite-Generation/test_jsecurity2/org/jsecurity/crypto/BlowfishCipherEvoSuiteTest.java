...
public class BlowfishCipherEvoSuiteTest {
   ...
   * 4 org.jsecurity.crypto.BlowfishCipher.encrypt([B[B)[B: I12 Branch 1 IFEQ L123 - true
   ...
   * 2 org.jsecurity.crypto.BlowfishCipher.decrypt([B[B)[B: I4 Branch 4 IFEQ L135 - true
  ...
  public void test2()  throws Throwable  {
      ...
      try {
        blowfishCipher0.decrypt(byteArray0, (byte[]) null);
        fail("Expecting exception: IllegalStateException");
      } catch(IllegalStateException e) {
        /*
         * Unable to crypt bytes with cipher [javax.crypto.Cipher@2344ca2d].
         */
      }
  }
}
