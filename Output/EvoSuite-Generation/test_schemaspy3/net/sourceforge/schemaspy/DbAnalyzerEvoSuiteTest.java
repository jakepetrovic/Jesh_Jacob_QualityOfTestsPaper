...
public class DbAnalyzerEvoSuiteTest {
   ...
   * 3 net.sourceforge.schemaspy.DbAnalyzer.getTablesWithIncrementingColumnNames(Ljava/util/Collection;)Ljava/util/List;: I14 Branch 34 IFEQ L210 - true
   */
  @Test
  public void test1()  throws Throwable  {
      HashSet<Table> hashSet0 = new HashSet<Table>();
      List<Table> list0 = DbAnalyzer.getTablesWithIncrementingColumnNames((Collection<Table>) hashSet0);
      assertEquals(0, list0.size());
  }
  ...
  public void test8()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        DbAnalyzer.getMustBeUniqueNullableColumns((Collection<Table>) hashSet0);
        fail("Expecting exception: NullPointerException");
      } catch(NullPointerException e) {
      }
  }
  ...
  /*
   * 3 covered goals:
   * 1 net.sourceforge.schemaspy.DbAnalyzer.getTablesWithOneColumn(Ljava/util/Collection;)Ljava/util/List;: I14 Branch 42 IFEQ L254 - true
  ...
  public void test11()  throws Throwable  {
      LinkedList<Table> linkedList0 = new LinkedList<Table>();
      List<TableColumn> list0 = DbAnalyzer.getDefaultNullStringColumns((Collection<Table>) linkedList0);
      assertEquals(true, list0.isEmpty());
  }
