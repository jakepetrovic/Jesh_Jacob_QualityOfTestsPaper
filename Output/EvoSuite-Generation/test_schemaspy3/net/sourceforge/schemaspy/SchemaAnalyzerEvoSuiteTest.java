...
public class SchemaAnalyzerEvoSuiteTest {
  ...
  public void test1()  throws Throwable  {
      ...
      try {
        schemaAnalyzer0.getConnection(config0, "@~:D&u|>]fm#cjd G)", "@~:D&u|>]fm#cjd G)", "@~:D&u|>]fm#cjd G)");
        fail("Expecting exception: ConnectionFailure");
      } catch(ConnectionFailure e) {
        /*
         * java.lang.ClassNotFoundException: Unmatched closing ')' near index 18
         * .*@~:D&u|>]fm#cjd G).class
         *                   ^
         */
      }
  ...
  /*
   * 1 covered goal:
   * 1 net.sourceforge.schemaspy.SchemaAnalyzer.getDriver(Ljava/lang/String;Ljava/lang/String;)Ljava/sql/Driver;: I86 Branch 80 IFGT L639 - true
   */
  @Test
  ...
  public void test3()  throws Throwable  {
      ...
      // Undeclared exception!
      try {
        schemaAnalyzer0.getConnection(config0, "%}%By79", "", "%}%By79");
        fail("Expecting exception: ConnectionFailure");
      } catch(ConnectionFailure e) {
        /*
  ...
  public void test4()  throws Throwable  {
      ...
      SchemaAnalyzer.yankParam(list0, "rIm[)");
