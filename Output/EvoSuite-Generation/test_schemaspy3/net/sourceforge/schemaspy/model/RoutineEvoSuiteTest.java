...
public class RoutineEvoSuiteTest {
  ...
  /*
   * 7 covered goals:
   * 1 net.sourceforge.schemaspy.model.Routine.getReturnType()Ljava/lang/String;: root-Branch
   * 2 net.sourceforge.schemaspy.model.Routine.getType()Ljava/lang/String;: root-Branch
   * 3 net.sourceforge.schemaspy.model.Routine.getDefinition()Ljava/lang/String;: root-Branch
   * 4 net.sourceforge.schemaspy.model.Routine.getName()Ljava/lang/String;: root-Branch
   * 5 net.sourceforge.schemaspy.model.Routine.compareTo(Lnet/sourceforge/schemaspy/model/Routine;)I: I11 Branch 1 IFNE L155 - false
   * 6 net.sourceforge.schemaspy.model.Routine.compareTo(Lnet/sourceforge/schemaspy/model/Routine;)I: I23 Branch 2 IFNE L157 - false
   * 7 net.sourceforge.schemaspy.model.Routine.compareTo(Lnet/sourceforge/schemaspy/model/Routine;)I: I37 Branch 3 IFNE L159 - false
   */
  @Test
  ...
  public void test8()  throws Throwable  {
      Routine routine0 = new Routine("", "", "", "", "", false, "", "", "");
      Routine routine1 = new Routine("(p", "(p", "(p", "(p", "(p", true, "(p", "(p", "(p");
