...
public class InflectionEvoSuiteTest {
  ...
  public void test0()  throws Throwable  {
      Inflection inflection0 = new Inflection("equipment");
  ...
  public void test1()  throws Throwable  {
      Inflection inflection0 = new Inflection("sheep", "sheep");
      assertNotNull(inflection0);
  }
   ...
   * 2 net.sourceforge.schemaspy.util.Inflection.singularize(Ljava/lang/String;)Ljava/lang/String;: I4 Branch 6 IFEQ L191 - true
   * 3 net.sourceforge.schemaspy.util.Inflection.singularize(Ljava/lang/String;)Ljava/lang/String;: I17 Branch 7 IFEQ L195 - true
   * 4 net.sourceforge.schemaspy.util.Inflection.singularize(Ljava/lang/String;)Ljava/lang/String;: I17 Branch 7 IFEQ L195 - false
   * 5 net.sourceforge.schemaspy.util.Inflection.singularize(Ljava/lang/String;)Ljava/lang/String;: I27 Branch 8 IFEQ L197 - true
   * 6 net.sourceforge.schemaspy.util.Inflection.isUncountable(Ljava/lang/String;)Z: I8 Branch 9 IFEQ L211 - true
   * 7 net.sourceforge.schemaspy.util.Inflection.isUncountable(Ljava/lang/String;)Z: I8 Branch 9 IFEQ L211 - false
   * 8 net.sourceforge.schemaspy.util.Inflection.isUncountable(Ljava/lang/String;)Z: I18 Branch 10 IFLE L212 - true
   */
  @Test
  public void test3()  throws Throwable  {
      String string0 = Inflection.singularize("KZ!R$r(tflPfk0hPf");
      assertEquals("KZ!R$r(tflPfk0hPf", string0);
  }
  ...
  /*
   * 5 covered goals:
   * 1 net.sourceforge.schemaspy.util.Inflection.replace(Ljava/lang/String;)Ljava/lang/String;: I8 Branch 2 IFEQ L161 - false
   * 2 net.sourceforge.schemaspy.util.Inflection.pluralize(Ljava/lang/String;)Ljava/lang/String;: I4 Branch 3 IFEQ L173 - true
   * 3 net.sourceforge.schemaspy.util.Inflection.pluralize(Ljava/lang/String;)Ljava/lang/String;: I17 Branch 4 IFEQ L177 - false
   * 4 net.sourceforge.schemaspy.util.Inflection.pluralize(Ljava/lang/String;)Ljava/lang/String;: I27 Branch 5 IFEQ L178 - true
   * 5 net.sourceforge.schemaspy.util.Inflection.pluralize(Ljava/lang/String;)Ljava/lang/String;: I27 Branch 5 IFEQ L178 - false
   */
  @Test
  public void test5()  throws Throwable  {
      String string0 = Inflection.pluralize("KZ!R$r(tflPfk0hPf");
      assertEquals("KZ!R$r(tflPfk0hPfs", string0);
  ...
  public void test6()  throws Throwable  {
      String string0 = Inflection.pluralize("sheep");
      assertNotNull(string0);
      assertEquals("sheep", string0);
  }
  ...
  public void test8()  throws Throwable  {
      String string0 = Inflection.singularize("KZ!R$r(tflPfk0hPfs");
      assertNotNull(string0);
      assertEquals("KZ!R$r(tflPfk0hPf", string0);
  }
}
