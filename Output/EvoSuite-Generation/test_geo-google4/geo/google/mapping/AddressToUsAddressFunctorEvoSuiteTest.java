...
public class AddressToUsAddressFunctorEvoSuiteTest {
  ...
  /*
   * 1 covered goal:
   * 1 geo.google.mapping.AddressToUsAddressFunctor.getInstance()Lgeo/google/mapping/AddressToUsAddressFunctor;: root-Branch
   */
  @Test
  ...
  /*
   * 3 covered goals:
   * 1 geo.google.mapping.AddressToUsAddressFunctor.execute(Lgeo/google/datamodel/GeoAddress;)Lgeo/google/datamodel/GeoUsAddress;: I15 Branch 1 IFNULL L36 - true
   * 2 geo.google.mapping.AddressToUsAddressFunctor.execute(Lgeo/google/datamodel/GeoAddress;)Lgeo/google/datamodel/GeoUsAddress;: I194 Branch 14 IFNULL L87 - true
   * 3 geo.google.mapping.AddressToUsAddressFunctor.<init>()V: root-Branch
   */
  @Test
   ...
   * 2 geo.google.mapping.AddressToUsAddressFunctor.<init>()V: root-Branch
