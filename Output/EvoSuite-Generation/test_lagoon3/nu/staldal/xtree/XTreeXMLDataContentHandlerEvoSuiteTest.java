...
public class XTreeXMLDataContentHandlerEvoSuiteTest {
  ...
  public void test2()  throws Throwable  {
      XTreeXMLDataContentHandler xTreeXMLDataContentHandler0 = new XTreeXMLDataContentHandler();
      try {
        xTreeXMLDataContentHandler0.writeTo((Object) "image/x-java-image; class=java.awt.Image; humanpresentablename=Image", "image/x-java-image; class=java.awt.Image; humanpresentablename=Image", (OutputStream) null);
