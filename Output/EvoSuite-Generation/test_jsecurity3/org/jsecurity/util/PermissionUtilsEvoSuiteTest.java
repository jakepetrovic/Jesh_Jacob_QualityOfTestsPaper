...
public class PermissionUtilsEvoSuiteTest {
  ...
  public void test1()  throws Throwable  {
      ...
      Set<Permission> set0 = PermissionUtils.resolveDelimitedPermissions("^5.F.bKVG", (PermissionResolver) wildcardPermissionResolver0);
      assertNotNull(set0);
   ...
   * 2 org.jsecurity.util.PermissionUtils.resolveDelimitedPermissions(Ljava/lang/String;Lorg/jsecurity/authz/permission/PermissionResolver;)Ljava/util/Set;: root-Branch
   */
  @Test
  public void test2()  throws Throwable  {
      ...
      try {
        PermissionUtils.resolveDelimitedPermissions("", (PermissionResolver) wildcardPermissionResolver0);
