...
public class StringUtilsEvoSuiteTest {
   ...
   * 7 org.jsecurity.util.StringUtils.tokenizeToStringArray(Ljava/lang/String;Ljava/lang/String;ZZ)[Ljava/lang/String;: I47 Branch 16 IFLE L215 - true
  ...
  public void test1()  throws Throwable  {
      String[] stringArray0 = StringUtils.tokenizeToStringArray(" ", "<r]jL'tqg_{hUgtg0");
  ...
  public void test2()  throws Throwable  {
      boolean boolean0 = StringUtils.hasText("ucKeu");
  ...
  public void test8()  throws Throwable  {
      boolean boolean0 = StringUtils.startsWithIgnoreCase("0($", (String) null);
      assertEquals(false, boolean0);
  }
  ...
  public void test9()  throws Throwable  {
      boolean boolean0 = StringUtils.startsWithIgnoreCase("ucKeu", "which the split location could be determined.");
      assertEquals(false, boolean0);
  }
  ...
  public void test10()  throws Throwable  {
      boolean boolean0 = StringUtils.startsWithIgnoreCase("`F6C=J7]xULsH@V]S-s", "]");
      assertEquals(false, boolean0);
  }
   ...
   * 6 org.jsecurity.util.StringUtils.splitKeyValue(Ljava/lang/String;)[Ljava/lang/String;: I105 Branch 22 IFNONNULL L265 - true
   * 7 org.jsecurity.util.StringUtils.splitKeyValue(Ljava/lang/String;)[Ljava/lang/String;: I132 Branch 23 IFNONNULL L269 - true
   * 8 org.jsecurity.util.StringUtils.clean(Ljava/lang/String;)Ljava/lang/String;: I7 Branch 10 IFNULL L149 - false
   */
  @Test
  public void test12()  throws Throwable  {
      String[] stringArray0 = StringUtils.splitKeyValue("63Y]`MG{\u0004f==!DWX6");
      assertNotNull(stringArray0);
  }
  ...
  public void test14()  throws Throwable  {
      String[] stringArray0 = StringUtils.tokenizeToStringArray("P5RR >zV&JO[jvrzWD", "C", false, false);
      assertNotNull(stringArray0);
  }
  ...
  /*
   * 8 covered goals:
   * 1 org.jsecurity.util.StringUtils.tokenizeToStringArray(Ljava/lang/String;Ljava/lang/String;ZZ)[Ljava/lang/String;: I47 Branch 16 IFLE L215 - false
  ...
  public void test15()  throws Throwable  {
      String[] stringArray0 = StringUtils.tokenizeToStringArray("`F6C=J7]xULsH@V]S-s", "");
      assertNotNull(stringArray0);
  }
  ...
  public void test18()  throws Throwable  {
      String[] stringArray0 = StringUtils.splitKeyValue("which the split location could be determined.");
      assertNotNull(stringArray0);
  }
  ...
  public void test19()  throws Throwable  {
      try {
        StringUtils.splitKeyValue("m");
        fail("Expecting exception: ParseException");
      } catch(ParseException e) {
        /*
         * Unable to determine Key/Value pair from line [m].  There is no space from which the split location could be determined.
         */
      }
  }
  ...
  public void test20()  throws Throwable  {
      try {
        StringUtils.splitKeyValue("=\"[;J6Py~");
        fail("Expecting exception: ParseException");
      } catch(ParseException e) {
        /*
         * No valid key could be found in line [=\"[;J6Py~] to form a key/value pair.
         */
      }
  }
   ...
   * 7 org.jsecurity.util.StringUtils.split(Ljava/lang/String;CCCZZ)[Ljava/lang/String;: I109 Branch 33 IFNE L344 - true
  ...
  public void test21()  throws Throwable  {
      String[] stringArray0 = StringUtils.split("which the split location could be determined.", '.', '.', 'c', true, true);
      assertNotNull(stringArray0);
  }
   ...
   * 2 org.jsecurity.util.StringUtils.split(Ljava/lang/String;CCCZZ)[Ljava/lang/String;: I83 Branch 30 IFNE L338 - false
   ...
   * 5 org.jsecurity.util.StringUtils.split(Ljava/lang/String;CCCZZ)[Ljava/lang/String;: I109 Branch 33 IFNE L344 - true
   * 6 org.jsecurity.util.StringUtils.split(Ljava/lang/String;CCCZZ)[Ljava/lang/String;: I119 Branch 34 IFEQ L345 - false
   */
  @Test
  public void test22()  throws Throwable  {
      String[] stringArray0 = StringUtils.split("}orNoU_:=-jdBtQ QR", '/', '', ':', true, false);
      assertNotNull(stringArray0);
  }
  ...
  public void test23()  throws Throwable  {
      String[] stringArray0 = StringUtils.split("}orNoU_:=-jdBtQ QR", '', '', 'o');
      assertNotNull(stringArray0);
  }
  ...
  public void test24()  throws Throwable  {
      String[] stringArray0 = StringUtils.split("J71am2axOv//O;;a", '2', '\'');
      assertNotNull(stringArray0);
  }
   ...
   * 6 org.jsecurity.util.StringUtils.split(Ljava/lang/String;CCCZZ)[Ljava/lang/String;: I48 Branch 26 IF_ICMPNE L327 - false
   ...
   * 9 org.jsecurity.util.StringUtils.split(Ljava/lang/String;CCCZZ)[Ljava/lang/String;: I93 Branch 31 IFEQ L339 - true
   * 10 org.jsecurity.util.StringUtils.split(Ljava/lang/String;CCCZZ)[Ljava/lang/String;: I181 Branch 38 IFEQ L360 - false
   */
  @Test
  public void test25()  throws Throwable  {
      String[] stringArray0 = StringUtils.split("3\",I{D*v*{t");
      assertNotNull(stringArray0);
  }
  ...
  public void test26()  throws Throwable  {
      String[] stringArray0 = StringUtils.split("XzmKbGz<_0N %!-pB>", 'N', '[', 'n', true, false);
      assertNotNull(stringArray0);
  }
}
