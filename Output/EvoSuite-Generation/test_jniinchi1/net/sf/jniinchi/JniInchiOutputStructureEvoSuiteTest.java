...
public class JniInchiOutputStructureEvoSuiteTest {
  ...
  public void test0()  throws Throwable  {
      JniInchiOutputStructure jniInchiOutputStructure0 = new JniInchiOutputStructure((-1570), "", "I@`tq", (long) (-1570), (long) (-1570), (long) (-1570), (long) (-1570));
      assertNotNull(jniInchiOutputStructure0);
      
      jniInchiOutputStructure0.getReturnStatus();
      assertEquals("", jniInchiOutputStructure0.getMessage());
      assertEquals("I@`tq", jniInchiOutputStructure0.getLog());
  }
