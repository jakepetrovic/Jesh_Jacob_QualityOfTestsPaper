...
public class TimeOfDayEvoSuiteTest {
  ...
  public void test5()  throws Throwable  {
      TimeOfDay timeOfDay0 = new TimeOfDay(0, 0);
      TimeOfDay timeOfDay1 = new TimeOfDay((-845), (-1));
      int int0 = timeOfDay1.compareTo(timeOfDay0);
      assertEquals((-1), int0);
      assertEquals("-845:-1", timeOfDay1.toString());
  }
  ...
  public void test7()  throws Throwable  {
      TimeOfDay timeOfDay0 = new TimeOfDay(0, 1468);
      boolean boolean0 = timeOfDay0.equals((Object) null);
      assertEquals("0:1468", timeOfDay0.toString());
      assertEquals(false, boolean0);
  }
  ...
  public void test8()  throws Throwable  {
      TimeOfDay timeOfDay0 = new TimeOfDay(0, 1468);
      boolean boolean0 = timeOfDay0.equals((Object) "2028");
      assertEquals(false, boolean0);
      assertEquals("0:1468", timeOfDay0.toString());
  }
   ...
   * 2 net.sf.lavalamp.device.TimeOfDay.equals(Ljava/lang/Object;)Z: I52 Branch 6 IFNE L61 - false
   * 3 net.sf.lavalamp.device.TimeOfDay.equals(Ljava/lang/Object;)Z: I4 Branch 2 IF_ACMPNE L52 - true
   */
  @Test
  public void test9()  throws Throwable  {
      TimeOfDay timeOfDay0 = new TimeOfDay((-1161), (-1161));
      TimeOfDay timeOfDay1 = new TimeOfDay((-1161), 0);
      boolean boolean0 = timeOfDay0.equals((Object) timeOfDay1);
      assertEquals(false, boolean0);
      assertEquals("-1161:0", timeOfDay1.toString());
      assertEquals("-1161:-1161", timeOfDay0.toString());
  }
   ...
   * 4 net.sf.lavalamp.device.TimeOfDay.equals(Ljava/lang/Object;)Z: I4 Branch 2 IF_ACMPNE L52 - false
   * 5 net.sf.lavalamp.device.TimeOfDay.equals(Ljava/lang/Object;)Z: I12 Branch 3 IFNONNULL L54 - true
   * 6 net.sf.lavalamp.device.TimeOfDay.equals(Ljava/lang/Object;)Z: I23 Branch 4 IF_ACMPEQ L56 - true
   * 7 net.sf.lavalamp.device.TimeOfDay.equals(Ljava/lang/Object;)Z: I40 Branch 5 IFNE L59 - true
   */
  @Test
  public void test10()  throws Throwable  {
      TimeOfDay timeOfDay0 = new TimeOfDay(1, 1);
      Integer integer0 = timeOfDay0.getMinutes();
      TimeOfDay timeOfDay1 = new TimeOfDay(1, (int) integer0);
