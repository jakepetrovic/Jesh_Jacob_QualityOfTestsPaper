...
public class MenuItemListEvoSuiteTest {
   ...
   * 5 ch.bluepenguin.tapestry.components.menu.model.impl.MenuItemList.addChild(Lch/bluepenguin/tapestry/components/menu/model/impl/MenuItemList;)V: I4 Branch 1 IFNONNULL L23 - true
   * 6 ch.bluepenguin.tapestry.components.menu.model.impl.MenuItemList.getMenuItem()Lch/bluepenguin/tapestry/components/menu/model/IMenuItem;: root-Branch
   */
  @Test
   ...
   * 3 ch.bluepenguin.tapestry.components.menu.model.impl.MenuItemList.checkConsistency()Z: I13 Branch 2 IF_ICMPGE L43 - false
   * 4 ch.bluepenguin.tapestry.components.menu.model.impl.MenuItemList.checkConsistency()Z: I15 Branch 3 IFEQ L43 - false
   * 5 ch.bluepenguin.tapestry.components.menu.model.impl.MenuItemList.checkConsistency()Z: I23 Branch 4 IFNE L45 - true
   * 6 ch.bluepenguin.tapestry.components.menu.model.impl.MenuItemList.addChild(Lch/bluepenguin/tapestry/components/menu/model/impl/MenuItemList;)V: I4 Branch 1 IFNONNULL L23 - false
   * 7 ch.bluepenguin.tapestry.components.menu.model.impl.MenuItemList.checkConsistency()Z: I13 Branch 2 IF_ICMPGE L43 - true
   */
  @Test
  public void test3()  throws Throwable  {
      ...
      DefaultMenuItem defaultMenuItem0 = new DefaultMenuItem(object0);
      MenuItemList menuItemList0 = new MenuItemList((IMenuItem) defaultMenuItem0);
      MenuItemList menuItemList1 = new MenuItemList((IMenuItem) null);
      menuItemList1.addChild(menuItemList0);
      boolean boolean0 = menuItemList1.checkConsistency();
      assertEquals(1, menuItemList1.getChildrenSize());
  ...
  /*
   * 1 covered goal:
   * 1 ch.bluepenguin.tapestry.components.menu.model.impl.MenuItemList.checkConsistency()Z: I13 Branch 2 IF_ICMPGE L43 - true
   */
  @Test
