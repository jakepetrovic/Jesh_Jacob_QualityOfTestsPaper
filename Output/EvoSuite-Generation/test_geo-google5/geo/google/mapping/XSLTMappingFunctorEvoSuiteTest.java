...
public class XSLTMappingFunctorEvoSuiteTest {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
        xSLTMappingFunctor0.execute(";;s)wJ");
        fail("Expecting exception: GeoException");
      } catch(GeoException e) {
        /*
         * javax.xml.transform.TransformerConfigurationException: The input document is not a stylesheet (the XSL namespace is not declared in the root element).
         */
      }
  }
  ...
  public void test1()  throws Throwable  {
      DOMSource dOMSource0 = new DOMSource();
      XSLTMappingFunctor xSLTMappingFunctor0 = new XSLTMappingFunctor((Source) dOMSource0);
      DOMSource dOMSource1 = (DOMSource)xSLTMappingFunctor0.getXsltSource();
      assertSame(dOMSource1, dOMSource0);
  }
