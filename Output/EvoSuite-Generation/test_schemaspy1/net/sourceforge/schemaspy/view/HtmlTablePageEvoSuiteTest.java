...
public class HtmlTablePageEvoSuiteTest {
  ...
  public void test1()  throws Throwable  {
      HtmlTablePage htmlTablePage0 = HtmlTablePage.getInstance();
      HtmlFormatter.urlEncode("JQIxFriemc@");
      HashSet<TableColumn> hashSet0 = new HashSet<TableColumn>();
      // Undeclared exception!
      try {
        htmlTablePage0.writeColumn((TableColumn) null, "JQIxFriemc%40", (Set<TableColumn>) hashSet0, (Set<TableColumn>) hashSet0, true, true, (LineWriter) null);
