...
public class ResourceWriterEvoSuiteTest {
  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          ...
          try {
            resourceWriter0.writeResource("", file0);
            fail("Expecting exception: SecurityException");
          } catch(SecurityException e) {
            /*
             * Security manager blocks (\"java.io.FilePermission\" \"/Resource \"\" \"write\")
  ...
  public void test1()  throws Throwable  {
      ...
      File file0 = new File("4%Vs+'");
      File file1 = file0.getAbsoluteFile();
      try {
        resourceWriter0.writeResource("4%Vs+'", file1);
        fail("Expecting exception: IOException");
      } catch(IOException e) {
        /*
         * Resource \"4%Vs+'\" not found
         */
      }
  }
}
