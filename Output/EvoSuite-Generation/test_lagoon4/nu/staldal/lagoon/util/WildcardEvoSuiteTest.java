...
public class WildcardEvoSuiteTest {
  ...
  public void test0()  throws Throwable  {
      boolean boolean0 = Wildcard.isWildcard("q3|jQH*3R?$2Y");
  ...
  public void test2()  throws Throwable  {
      boolean boolean0 = Wildcard.isWildcard(":uU#8oU,+b;>Pp");
      assertEquals(true, boolean0);
  }
  ...
  /*
   * 5 covered goals:
   * 1 nu.staldal.lagoon.util.Wildcard.matchWildcard(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;: I12 Branch 3 IFEQ L82 - false
   * 2 nu.staldal.lagoon.util.Wildcard.matchWildcard(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;: I27 Branch 4 IFGE L87 - true
   * 3 nu.staldal.lagoon.util.Wildcard.matchWildcard(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;: I45 Branch 6 IFGT L93 - true
   * 4 nu.staldal.lagoon.util.Wildcard.matchWildcard(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;: I58 Branch 7 IFGT L96 - false
  ...
  public void test3()  throws Throwable  {
      String string0 = Wildcard.matchWildcard("q3|jQH*3R?$2YLf*@sA&F==oW*>4+{", "q3|jQH*3R?$2Y");
      assertNull(string0);
  }
   ...
   * 2 nu.staldal.lagoon.util.Wildcard.matchWildcard(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;: I33 Branch 5 IFLE L89 - true
   */
  @Test
  public void test4()  throws Throwable  {
      String string0 = Wildcard.matchWildcard("/u!A|oGJqH|,{C!q", "");
      assertNull(string0);
  }
  ...
  public void test5()  throws Throwable  {
      String string0 = Wildcard.matchWildcard("UMkp3jd%%o2,", "UMkp3jd%%o2,");
  ...
  public void test7()  throws Throwable  {
      String string0 = Wildcard.matchWildcard("*Lf*@sA&F==oW*>4+{", "*Lf*@sA&F==oW*>4+{");
      assertNotNull(string0);
      assertEquals("*", string0);
  }
  ...
  public void test8()  throws Throwable  {
      String string0 = Wildcard.instantiateWildcard("*Lf*@sA&F==oW*>4+{", "q3|jQH*3R?$2Y");
      assertEquals("q3|jQH*3R?$2YLf*@sA&F==oW*>4+{", string0);
      assertNotNull(string0);
  }
