...
public class BuildsEvoSuiteTest {
  ...
  public void test1()  throws Throwable  {
      Builds builds0 = new Builds();
      Build build0 = new Build("9{hQJsQ]!eT&Vhh[");
      builds0.add(build0);
  ...
  public void test4()  throws Throwable  {
      ...
      Build build0 = new Build("9{hQJsQ]!eT&Vhh[");
      builds0.add(build0);
      Build build1 = builds0.getBuild("9{hQJsQ]!eT&Vhh[");
      assertEquals("<font color='green'> build 9{hQJsQ]!eT&Vhh[ successful (null)</font>", build1.toString());
  }
