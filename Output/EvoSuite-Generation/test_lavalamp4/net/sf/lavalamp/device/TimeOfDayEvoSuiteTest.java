...
public class TimeOfDayEvoSuiteTest {
  ...
  public void test0()  throws Throwable  {
      TimeOfDay timeOfDay0 = new TimeOfDay((-1295), (-1295));
      Integer integer0 = timeOfDay0.getMinutes();
      assertEquals("-1295:-1295", timeOfDay0.toString());
  ...
  public void test1()  throws Throwable  {
      ...
      assertEquals("-1295:-1295", string0);
  }
  ...
  public void test4()  throws Throwable  {
      TimeOfDay timeOfDay0 = new TimeOfDay(100, (-1514));
      TimeOfDay timeOfDay1 = new TimeOfDay(0, 1);
      int int0 = timeOfDay0.compareTo(timeOfDay1);
      assertEquals("100:-1514", timeOfDay0.toString());
      assertEquals(1, int0);
  }
  ...
  public void test6()  throws Throwable  {
      TimeOfDay timeOfDay0 = new TimeOfDay((-1295), (-1295));
      TimeOfDay timeOfDay1 = new TimeOfDay(75, 75);
      boolean boolean0 = timeOfDay1.equals((Object) timeOfDay0);
      assertEquals("75:75", timeOfDay1.toString());
      assertEquals(false, boolean0);
  }
   ...
   * 3 net.sf.lavalamp.device.TimeOfDay.<init>(Ljava/lang/String;)V: root-Branch
   * 4 net.sf.lavalamp.device.TimeOfDay.equals(Ljava/lang/Object;)Z: I4 Branch 2 IF_ACMPNE L52 - false
   */
  @Test
  public void test8()  throws Throwable  {
      TimeOfDay timeOfDay0 = new TimeOfDay(75, 75);
      TimeOfDay timeOfDay1 = new TimeOfDay("75:75");
