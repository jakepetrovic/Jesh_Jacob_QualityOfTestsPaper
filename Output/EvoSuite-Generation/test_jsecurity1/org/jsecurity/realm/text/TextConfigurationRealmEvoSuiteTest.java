...
public class TextConfigurationRealmEvoSuiteTest {
  ...
  public void test2()  throws Throwable  {
      ...
      assertEquals("org.jsecurity.realm.text.TextConfigurationRealm_40", textConfigurationRealm0.getName());
  }
   ...
   * 3 org.jsecurity.realm.text.TextConfigurationRealm.processRoleDefinitions()V: I8 Branch 1 IFNONNULL L126 - true
   * 4 org.jsecurity.realm.text.TextConfigurationRealm.processRoleDefinitions()V: I21 Branch 2 IFNULL L130 - false
   * 5 org.jsecurity.realm.text.TextConfigurationRealm.processRoleDefinitions()V: I24 Branch 3 IFLE L130 - true
   * 6 org.jsecurity.realm.text.TextConfigurationRealm.processRoleDefinitions()V: I37 Branch 4 IFEQ L134 - true
   * 7 org.jsecurity.realm.text.TextConfigurationRealm.processRoleDefinitions()V: I37 Branch 4 IFEQ L134 - false
   * 8 org.jsecurity.realm.text.TextConfigurationRealm.processRoleDefinitions()V: I58 Branch 5 IFNONNULL L138 - false
   * 9 org.jsecurity.realm.text.TextConfigurationRealm.toLines(Ljava/lang/String;)Ljava/util/Set;: I17 Branch 14 IFEQ L194 - false
   * 10 org.jsecurity.realm.text.TextConfigurationRealm.toMap(Ljava/util/Collection;)Ljava/util/Map;: I6 Branch 16 IFLE L201 - true
   * 11 org.jsecurity.realm.text.TextConfigurationRealm.toMap(Ljava/util/Collection;)Ljava/util/Map;: I25 Branch 17 IFEQ L206 - true
   * 12 org.jsecurity.realm.text.TextConfigurationRealm.toMap(Ljava/util/Collection;)Ljava/util/Map;: I25 Branch 17 IFEQ L206 - false
   */
  @Test
  public void test3()  throws Throwable  {
      TextConfigurationRealm textConfigurationRealm0 = new TextConfigurationRealm();
      textConfigurationRealm0.setRoleDefinitions("' is unable to initialize itself when loaded via classloader ");
      HashtableCache hashtableCache0 = new HashtableCache("' is unable to initialize itself when loaded via classloader ");
      textConfigurationRealm0.setAuthorizationCache((Cache) hashtableCache0);
      textConfigurationRealm0.processDefinitions();
      assertEquals("org.jsecurity.realm.text.TextConfigurationRealm_41", textConfigurationRealm0.getName());
  }
   ...
   * 21 org.jsecurity.realm.text.TextConfigurationRealm.processUserDefinitions()V: I95 Branch 11 IF_ICMPLE L175 - true
   * 22 org.jsecurity.realm.text.TextConfigurationRealm.processRoleDefinitions()V: I8 Branch 1 IFNONNULL L126 - false
   */
  @Test
  public void test4()  throws Throwable  {
      ...
      HashtableCache hashtableCache0 = new HashtableCache("' is unable to initialize itself when loaded via classloader ");
      textConfigurationRealm0.setAuthorizationCache((Cache) hashtableCache0);
      textConfigurationRealm0.setUserDefinitions("' is unable to initialize itself when loaded via classloader ");
      textConfigurationRealm0.processDefinitions();
      textConfigurationRealm0.afterAuthorizationCacheSet();
