...
public class JndiRealmFactoryEvoSuiteTest {
   ...
   * 4 org.jsecurity.realm.jndi.JndiRealmFactory.setJndiNames(Ljava/lang/String;)V: I8 Branch 1 IFNONNULL L82 - true
   * 5 org.jsecurity.realm.jndi.JndiRealmFactory.<init>()V: root-Branch
   * 6 org.jsecurity.realm.jndi.JndiRealmFactory.getJndiNames()Ljava/util/Collection;: root-Branch
   * 7 org.jsecurity.realm.jndi.JndiRealmFactory.getRealms()Ljava/util/Collection;: I8 Branch 2 IFNULL L103 - false
   */
  @Test
  public void test0()  throws Throwable  {
      JndiRealmFactory jndiRealmFactory0 = new JndiRealmFactory();
      jndiRealmFactory0.setJndiNames("1Cc[F4");
      try {
        jndiRealmFactory0.getRealms();
        fail("Expecting exception: IllegalStateException");
      } catch(IllegalStateException e) {
        /*
         * Unable to look up realm with jndi name '1Cc[F4'.
         */
      }
  }
   ...
   * 3 org.jsecurity.realm.jndi.JndiRealmFactory.<init>()V: root-Branch
  ...
  public void test3()  throws Throwable  {
      ...
      jndiRealmFactory0.jndiNames = (Collection<String>) linkedHashSet0;
      try {
        jndiRealmFactory0.getRealms();
        fail("Expecting exception: IllegalStateException");
      } catch(IllegalStateException e) {
