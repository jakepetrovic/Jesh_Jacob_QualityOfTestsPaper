...
public class EmailFacadeStateEvoSuiteTest {
   ...
   * 4 ch.bluepenguin.email.client.service.impl.EmailFacadeState.isAllClean()Z: I31 Branch 5 IFEQ L60 - false
   * 5 ch.bluepenguin.email.client.service.impl.EmailFacadeState.setState(Ljava/lang/Integer;Z)V: root-Branch
   * 6 ch.bluepenguin.email.client.service.impl.EmailFacadeState.<init>()V: root-Branch
   */
  @Test
  public void test0()  throws Throwable  {
      EmailFacadeState emailFacadeState0 = new EmailFacadeState();
      emailFacadeState0.setState((Integer) 1, true);
