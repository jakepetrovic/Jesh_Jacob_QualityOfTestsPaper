...
public class DefaultMenuModelEvoSuiteTest {
   ...
   * 5 ch.bluepenguin.tapestry.components.menu.model.impl.DefaultMenuModel.addMenuItem(Lch/bluepenguin/tapestry/components/menu/model/IMenuItem;)V: root-Branch
   ...
   * 9 ch.bluepenguin.tapestry.components.menu.model.impl.DefaultMenuModel.getMenuItemsRecursion(Lch/bluepenguin/tapestry/components/menu/model/impl/MenuItemList;Ljava/util/ArrayList;)V: I4 Branch 1 IFNULL L37 - true
   * 10 ch.bluepenguin.tapestry.components.menu.model.impl.DefaultMenuModel.getMenuItemsRecursion(Lch/bluepenguin/tapestry/components/menu/model/impl/MenuItemList;Ljava/util/ArrayList;)V: I20 Branch 2 IFEQ L39 - true
   */
  @Test
   ...
   * 6 ch.bluepenguin.tapestry.components.menu.model.impl.DefaultMenuModel.attachOrphans(Lch/bluepenguin/tapestry/components/menu/model/impl/MenuItemList;)V: I9 Branch 3 IF_ICMPGE L59 - false
   * 7 ch.bluepenguin.tapestry.components.menu.model.impl.DefaultMenuModel.attachOrphans(Lch/bluepenguin/tapestry/components/menu/model/impl/MenuItemList;)V: I36 Branch 4 IFNULL L64 - false
   * 8 ch.bluepenguin.tapestry.components.menu.model.impl.DefaultMenuModel.attachOrphans(Lch/bluepenguin/tapestry/components/menu/model/impl/MenuItemList;)V: I43 Branch 5 IFEQ L64 - true
   ...
   * 12 ch.bluepenguin.tapestry.components.menu.model.impl.DefaultMenuModel.findParentList(Lch/bluepenguin/tapestry/components/menu/model/IMenuItem;Lch/bluepenguin/tapestry/components/menu/model/impl/MenuItemList;)Lch/bluepenguin/tapestry/components/menu/model/impl/MenuItemList;: I39 Branch 9 IFEQ L82 - true
   * 13 ch.bluepenguin.tapestry.components.menu.model.impl.DefaultMenuModel.findParentList(Lch/bluepenguin/tapestry/components/menu/model/IMenuItem;Lch/bluepenguin/tapestry/components/menu/model/impl/MenuItemList;)Lch/bluepenguin/tapestry/components/menu/model/impl/MenuItemList;: I39 Branch 9 IFEQ L82 - false
   */
  @Test
  public void test3()  throws Throwable  {
      ...
      defaultMenuItem1.setParent(object0);
      defaultMenuModel0.addMenuItem((IMenuItem) defaultMenuItem1, (IMenuItemRenderer) defaultMenuItemRenderer0);
   ...
   * 4 ch.bluepenguin.tapestry.components.menu.model.impl.DefaultMenuModel.attachOrphans(Lch/bluepenguin/tapestry/components/menu/model/impl/MenuItemList;)V: I43 Branch 5 IFEQ L64 - true
   */
  @Test
