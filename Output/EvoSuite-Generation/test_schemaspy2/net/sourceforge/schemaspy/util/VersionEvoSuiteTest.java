...
public class VersionEvoSuiteTest {
   ...
   * 2 net.sourceforge.schemaspy.util.Version.compareTo(Lnet/sourceforge/schemaspy/util/Version;)I: I17 Branch 3 IF_ICMPGE L61 - false
   * 3 net.sourceforge.schemaspy.util.Version.compareTo(Lnet/sourceforge/schemaspy/util/Version;)I: I43 Branch 4 IFEQ L65 - true
   ...
   * 5 net.sourceforge.schemaspy.util.Version.<init>(Ljava/lang/String;)V: I23 Branch 1 IFNULL L41 - false
   * 6 net.sourceforge.schemaspy.util.Version.<init>(Ljava/lang/String;)V: I36 Branch 2 IFEQ L44 - true
   * 7 net.sourceforge.schemaspy.util.Version.<init>(Ljava/lang/String;)V: I36 Branch 2 IFEQ L44 - false
   */
  @Test
   ...
   * 5 net.sourceforge.schemaspy.util.Version.compareTo(Lnet/sourceforge/schemaspy/util/Version;)I: I60 Branch 5 IF_ICMPNE L69 - true
   */
  @Test
  public void test4()  throws Throwable  {
      ...
      Version version1 = new Version("3_5");
      assertNotNull(version1);
  ...
  public void test6()  throws Throwable  {
      ...
      boolean boolean0 = version0.equals((Object) "37777777777");
      assertEquals(false, boolean0);
  }
