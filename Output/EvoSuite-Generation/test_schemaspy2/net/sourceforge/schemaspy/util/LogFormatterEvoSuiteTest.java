...
public class LogFormatterEvoSuiteTest {
   ...
   * 3 net.sourceforge.schemaspy.util.LogFormatter.format(Ljava/util/logging/LogRecord;)Ljava/lang/String;: I110 Branch 3 IFNULL L105 - false
  ...
  public void test1()  throws Throwable  {
      ...
      assertEquals(4606L, logRecord0.getSequenceNumber());
      assertEquals("11:07:52.874 WARNING:  - \n", string0);
  }
   ...
   * 8 net.sourceforge.schemaspy.util.LogFormatter.format(Ljava/util/logging/LogRecord;)Ljava/lang/String;: I138 Branch 5 IF_ICMPGE L112 - true
  ...
  public void test2()  throws Throwable  {
      ...
      logRecord0.setSourceMethodName("HH:mm:ss.");
      String string0 = logFormatter0.format(logRecord0);
      assertEquals(4680L, logRecord0.getSequenceNumber());
      assertEquals("11:07:59.569 CONFIG:  HH:mm:ss..HH:mm:ss. - HH:mm:ss.\n", string0);
  }
}
