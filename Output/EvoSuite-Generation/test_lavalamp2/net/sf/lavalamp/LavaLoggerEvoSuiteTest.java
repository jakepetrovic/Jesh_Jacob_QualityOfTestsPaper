...
public class LavaLoggerEvoSuiteTest {
   ...
   * 3 net.sf.lavalamp.LavaLogger.debug(Ljava/util/Calendar;Ljava/lang/String;)V: I3 Branch 2 IFEQ L46 - false
   * 4 net.sf.lavalamp.LavaLogger.<init>()V: root-Branch
   */
  @Test
  ...
  public void test3()  throws Throwable  {
      LavaLogger lavaLogger0 = new LavaLogger();
      GregorianCalendar gregorianCalendar0 = new GregorianCalendar(0, 0, (-615));
      // Undeclared exception!
      try {
        lavaLogger0.error((Calendar) gregorianCalendar0, "\"ZB/nyfYQho3t=jo");
        fail("Expecting exception: NullPointerException");
      } catch(NullPointerException e) {
      }
  }
