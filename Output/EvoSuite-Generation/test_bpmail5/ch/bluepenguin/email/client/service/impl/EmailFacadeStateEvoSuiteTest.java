...
public class EmailFacadeStateEvoSuiteTest {
  ...
  public void test0()  throws Throwable  {
      ...
      emailFacadeState0.setState((Integer) 0, true);
  ...
  public void test2()  throws Throwable  {
      EmailFacadeState emailFacadeState0 = new EmailFacadeState();
      Integer integer0 = Integer.getInteger("p6',qz-8^i|UWHz", 0);
   ...
   * 2 ch.bluepenguin.email.client.service.impl.EmailFacadeState.isAllClean()Z: I19 Branch 4 IFEQ L58 - true
   * 3 ch.bluepenguin.email.client.service.impl.EmailFacadeState.isAllClean()Z: I19 Branch 4 IFEQ L58 - false
   * 4 ch.bluepenguin.email.client.service.impl.EmailFacadeState.isAllClean()Z: I31 Branch 5 IFEQ L60 - true
   * 5 ch.bluepenguin.email.client.service.impl.EmailFacadeState.isDirty(Ljava/lang/Integer;)Z: I11 Branch 1 IFNONNULL L42 - true
   */
  @Test
