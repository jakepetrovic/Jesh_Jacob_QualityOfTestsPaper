...
public class ExecutorServiceSessionValidationSchedulerEvoSuiteTest {
  ...
  public void test5()  throws Throwable  {
      ExecutorServiceSessionValidationScheduler executorServiceSessionValidationScheduler0 = new ExecutorServiceSessionValidationScheduler();
      executorServiceSessionValidationScheduler0.setInterval((-2046L));
      executorServiceSessionValidationScheduler0.enableSessionValidation();
      assertEquals((-2046L), executorServiceSessionValidationScheduler0.getInterval());
      assertEquals(false, executorServiceSessionValidationScheduler0.isEnabled());
  }
   ...
   * 2 org.jsecurity.session.mgt.ExecutorServiceSessionValidationScheduler.run()V: I27 Branch 3 IFEQ L91 - true
   * 3 org.jsecurity.session.mgt.ExecutorServiceSessionValidationScheduler.<init>(Lorg/jsecurity/session/mgt/ValidatingSessionManager;)V: root-Branch
   */
  @Test
