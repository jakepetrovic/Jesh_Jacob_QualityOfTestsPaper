...
public class UtilsEvoSuiteTest {
  ...
  public void test0()  throws Throwable  {
      String string0 = Utils.encodePath("\"-?1({{p@KC");
      assertNotNull(string0);
      assertEquals("\"--$1({{p@KC", string0);
  }
   ...
   * 3 nu.staldal.util.Utils.encodePath(Ljava/lang/String;)Ljava/lang/String;: I26 Branch 10 LOOKUPSWITCH L67 Case 126 - true
   */
  @Test
  public void test1()  throws Throwable  {
      String string0 = Utils.encodePath("3y)gj_C8geQ}R~$a!0");
      assertNotNull(string0);
      assertEquals("3y)gj__C8geQ}R~~$$a!0", string0);
  }
  ...
  public void test2()  throws Throwable  {
      String string0 = Utils.encodePath("Zha*K+Y0~sad^nu>g7V");
      assertEquals("Zha_K+Y0~~sad^nu>g7V", string0);
      assertNotNull(string0);
  }
   ...
   * 2 nu.staldal.util.Utils.encodePath(Ljava/lang/String;)Ljava/lang/String;: I26 Branch 6 LOOKUPSWITCH L67 Case 58 - true
   * 3 nu.staldal.util.Utils.encodePath(Ljava/lang/String;)Ljava/lang/String;: I16 Branch 1 IF_ICMPGE L64 - true
   * 4 nu.staldal.util.Utils.encodePath(Ljava/lang/String;)Ljava/lang/String;: I16 Branch 1 IF_ICMPGE L64 - false
   ...
   * 10 nu.staldal.util.Utils.encodePath(Ljava/lang/String;)Ljava/lang/String;: I26 Branch 7 LOOKUPSWITCH L67 Case 63 - false
   * 11 nu.staldal.util.Utils.encodePath(Ljava/lang/String;)Ljava/lang/String;: I26 Branch 8 LOOKUPSWITCH L67 Case 92 - false
   * 12 nu.staldal.util.Utils.encodePath(Ljava/lang/String;)Ljava/lang/String;: I26 Branch 9 LOOKUPSWITCH L67 Case 95 - true
  ...
  public void test3()  throws Throwable  {
      String string0 = Utils.encodePath(":u_<c]&{_G/<t<3");
      assertEquals("~u__<c]&{__G-<t<3", string0);
      assertNotNull(string0);
  }
  ...
  public void test4()  throws Throwable  {
      String string0 = Utils.encodePathAsIdentifier(":u_<c]&{_G/<t<3");
      assertNotNull(string0);
      assertEquals("_58_u__60_c_93__38__123__G_47__60_t_60_3", string0);
  }
  ...
  public void test5()  throws Throwable  {
      String string0 = Utils.encodePathAsIdentifier("k8:xv1G)_V7JXV");
      assertNotNull(string0);
      assertEquals("k8_58_xv1G_41__V7JXV", string0);
  }
  ...
  public void test6()  throws Throwable  {
      boolean boolean0 = Utils.absoluteURL(":u_<c]&{_G/<t<3");
  ...
  public void test8()  throws Throwable  {
      boolean boolean0 = Utils.absoluteURL("k8:xv1G)_V7JXV");
      assertEquals(true, boolean0);
  }
  ...
  public void test9()  throws Throwable  {
      boolean boolean0 = Utils.absoluteURL("Td7ME 8/;t:P");
      assertEquals(false, boolean0);
  }
  ...
  public void test11()  throws Throwable  {
      boolean boolean0 = Utils.pseudoAbsoluteURL(":u_<c]&{_G/<t<3");
      assertEquals(false, boolean0);
  }
  ...
  public void test12()  throws Throwable  {
      boolean boolean0 = Utils.pseudoAbsoluteURL("/NX|\"~*UP0f");
      assertEquals(true, boolean0);
  }
