...
%I stuck to using "we" here because this is the process "we" executed. Is this okay to leave this way?
...
\begin{tabular}{|l|l|l|}
\hline
\multicolumn{1}{|c|}{\textbf{Program}} & \multicolumn{1}{c|}{\textbf{*LOC}} & \multicolumn{1}{c|}{\textbf{Cyclomatic Complexity}} \\ \hline
...
\vspace{2 mm}
\caption{*Physical lines of code calculated by Java NCSS.}
\end{table}
...
%Will we need something like this?
