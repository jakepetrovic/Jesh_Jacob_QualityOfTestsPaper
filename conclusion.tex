...
%Secondly, what is the future of learning based tools such as  \evo? The tests may not be as modifiable as \codepro's, but the mutation scores in some cases matched and exceeded the mutation scores of manually written tests. If the cost of time and effort given from running  \evo is less and will generate almost the same results for a large program, perhaps developers ought to consider using a tool like  \evo.
