...
# CodePro ---------------------------------------------------------
p1 <- ggplot(data, aes(x=SLOC, y=CPMutation))
p2 <- p1 + theme_bw()
...
m=lm(CPMutation ~ poly(SLOC, 2), df)#2nd degree polynomial
...
m=lm(CPMutation ~ SLOC, df)#2nd degree polynomial-- need to fix
...
# Manual ---------------------------------------------------------
p1 <- ggplot(data, aes(x=SLOC, y=MMutation))
p2 <- p1 + theme_bw()
...
lm_poly_eqn = function(df){
m=lm(MMutation ~ poly(SLOC, 2), df)#2nd degree polynomial
eq <- substitute(italic(y) == a + b %.% italic(x)* + c %.% italic(x)^2* ","~~italic(r)^2~"="~r2,
list(a = format(coef(m)[1], digits = 2),
b = format(coef(m)[2], digits = 2),
c = format(coef(m)[3], digits = 2),
...
lm_line_eqn = function(df){
m=lm(MMutation ~ SLOC, df)#2nd degree polynomial-- need to fix
eq <- substitute(italic(y) == a + b %.% italic(x)*","~~italic(r)^2~"="~r2,
list(a = format(coef(m)[1], digits = 2),
b = format(coef(m)[2], digits = 2),
c = format(coef(m)[3], digits = 2),
...
# Evosuite ---------------------------------------------------------
p1 <- ggplot(data, aes(x=SLOC, y=EMutation))
p2 <- p1 + theme_bw()
...
lm_poly_eqn = function(df){
m=lm(EMutation ~ poly(SLOC, 2), df)#2nd degree polynomial
eq <- substitute(italic(y) == a + b %.% italic(x)* + c %.% italic(x)^2* ","~~italic(r)^2~"="~r2,
list(a = format(coef(m)[1], digits = 2),
b = format(coef(m)[2], digits = 2),
c = format(coef(m)[3], digits = 2),
...
lm_line_eqn = function(df){
m=lm(EMutation ~ SLOC, df)#2nd degree polynomial-- need to fix
eq <- substitute(italic(y) == a + b %.% italic(x)*","~~italic(r)^2~"="~r2,
list(a = format(coef(m)[1], digits = 2),
b = format(coef(m)[2], digits = 2),
c = format(coef(m)[3], digits = 2),
