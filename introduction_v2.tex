...
Although automatic test generation requires far less human time and effort than manual test generation, this time
savings may not be worthwhile if the quality of the resulting test suites is poor in terms of coverage or fault-finding
capability.  Alternatively, automatically generated tests may not be as useful as manually implemented ones if they are
too complex or difficult to maintain.  Therefore, this paper additionally examines the correlation between the
complexity and size of the original program and the automatically and manually generated test suites.  Finally, we
point out the benefits and challenges associated with using automatically generated tests instead of manually
implemented ones.
